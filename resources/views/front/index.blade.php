...
<html lang="en">
    ...
    <head>
      ...
      <link href="{{ asset('front/assets/vendor/owl.carouselmin.css') }}" rel="stylesheet">
      ...
      <section id="hero">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <!-- Slide 3 -->
            <div class="carousel-item" style="background-image: url({{ asset('front/assets/') }}assets/img/slide/slide-3.jpg)">
              <div class="carousel-container">
                <div class="container">
